...
angular
    .module('app')
    .controller('FmbMon2Ctrl', [   'CmmAjaxService'	
    							, 'CmmModalSrvc'
    							, 'CmmWorkerSrvc'
    							, '$rootScope'
    						    , 'CmmFactSrvc'
...
/*	//andon parameter
    ...
    function getEqptList(){
	    	...
	    	eqptCount = CmmAjaxService.select("bas/selectFmbPlc.do", self.eqptcountVo);
	    	eqptCount.then(function(data){
	    		...
	    		for(var i = 0;i<self.eqptList.length;i++){
	    			for(var k=0; k<data.length;k++){
		    			...
		    			if(self.eqptList[i].id == data[k].plcId){
			    			...
			    			self.eqptList[i].stsImg4 = "assets/img/system/Red5.png"
			    			self.eqptList[i].stsImg0 = "assets/img/system/Green5.png"
			    			break;
		    			}
	    			}
	    		}
